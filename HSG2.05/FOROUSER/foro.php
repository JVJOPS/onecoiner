...
<body>
    ...
    <a href="../INICIO_USER/inicio_user.php">Pagina de inicio</a>
    <?php foreach ($mensajes as $mensaje): ?>
        <div class="mensaje">
            ...
            <?php if ($_SESSION['id'] == $mensaje['usuario_id']): ?>
                <a href="editar_mensaje.php?id=<?php echo $mensaje['id']; ?>">Editar</a> |
                <a href="eliminar_mensaje.php?id=<?php echo $mensaje['id']; ?>">Eliminar</a>
            <?php endif; ?>
        </div>
    <?php endforeach; ?>
</body>
